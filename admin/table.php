        ...
        <div class="col-12">
          ...
          <div class="card">
            ...
            <?php
                ...
                $query= mysqli_query($connect, "select * from tbl_student") or die(mysqli_error($connect."Error in Query"));
            ?>
            <div class="card-body">
                        ...
                        while ($row= mysqli_fetch_array($query))
                        {
                            echo "<tr>";
                              ...
                              /*  echo "<td>
                                    <div>
                                        <a href='delete.php'>
                                        <button type='button' class='btn btn-primary'>Deletet</button>
                                        </a>
                                    </div>
                                </td>";*/
                            echo "</tr>";
